...
#line 4 "/home/bayashi/dev/byslib/graph/lca.hpp"
...
void Solver::solve() {
    ...
    LowestCommonAncestor lca(graph, root);
    for (UV : Range(scanner.read<int>())) {
        auto [a, b] = scanner.read<int, 2>();
        --a, --b;
        print(lca.lca(a, b) == b ? "Yes" : "No");
    }
}
}  // namespace bys
