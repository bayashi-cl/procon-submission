#line 2 "/home/bayashi/dev/byslib/byslib/template/acl.hpp"
...
#include <complex>
#include <iomanip>
#line 13 "/home/bayashi/dev/byslib/byslib/template/bys.hpp"
#include <iterator>
#include <limits>
#include <map>
#include <numeric>
...
mint7 calc(ull x) {
    ...
    ull low = 1;
    while (low <= x) {
        ull high = min(low * 10 - 1, x);
        mint7 t = mint7(low + high) * mint7(high - low + 1) / 2;
        res += t * l;
        ++l;
        low *= 10;
    }
