...
void solve() {
    ...
    VecVec row(h, Vec(w)), col(h, Vec(w));
    for (int i = 0; i < h; ++i) {
        bool space = false;
        int l = 0, cnt = 0;
        for (int j = 0; j < w; ++j) {
