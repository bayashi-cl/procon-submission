...
def range_sum(r: range) -> int:
    start = r.start
    end = r[-1]
    step = r.step
    n = max((end - start) // step + 1, 0)
...
def main(**kwargs) -> None:
    ...
    ans = range_sum(range(n + 1))
    ans -= range_sum(range(0, n + 1, a))
    ans -= range_sum(range(0, n + 1, b))
    ans += range_sum(range(0, n + 1, l))
