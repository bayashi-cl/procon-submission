...
void main() {
    auto s = input<string>();
    string key = "WBWBWWBWBWBWWBWBWWBWBWBWWBWBWWBWBWBWWBWB";
    if (s == key.substr(0, 20)) {
        print("Do");
    } else if (s == key.substr(2, 20)) {
        print("Re");
    } else if (s == key.substr(4, 20)) {
        print("Mi");
    } else if (s == key.substr(5, 20)) {
        print("Fa");
    } else if (s == key.substr(7, 20)) {
        print("So");
    } else if (s == key.substr(9, 20)) {
        print("La");
    } else if (s == key.substr(11, 20)) {
        print("Si");
    }
}
