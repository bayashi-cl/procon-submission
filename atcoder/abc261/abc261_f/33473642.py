...
BundleImporter.add_module(
    fullname="sortedcontainers.sortedlist",
    is_package=False,
    code="""\
\"""Sorted List
==============
...
BundleImporter.add_module(
    fullname="sortedcontainers.sortedset",
    is_package=False,
    code="""\
\"""Sorted Set
=============
...
BundleImporter.add_module(
    fullname="sortedcontainers.sorteddict",
    is_package=False,
    code="""\
\"""Sorted Dict
==============
...
def main(**kwargs) -> None:
    ...
    x = list(map(int1, readline().split()))

    cnt = [SortedList() for _ in range(n)]
    ans = 0
    ...
    for i in range(n):
        ...
        bit.point_append(xi, 1)
        cnt[ci].add(xi)
        same = len(cnt[ci]) - cnt[ci].bisect_right(xi)
        ans += bit.fold(xi + 1, n) - same
