...
sortedcontainers = ModuleType("sortedcontainers")
sortedcontainers.sortedset = ModuleType("sortedcontainers.sortedset")
sortedcontainers.sortedlist = ModuleType("sortedcontainers.sortedlist")
sortedcontainers.sorteddict = ModuleType("sortedcontainers.sorteddict")

_code_sortedcontainers_sortedlist = """
\"""Sorted List
==============
...
"""
exec(_code_sortedcontainers_sortedlist, sortedcontainers.sortedlist.__dict__)

_code_sortedcontainers_sortedset = """
\"""Sorted Set
=============
...
"""
sortedcontainers.sortedset.__dict__["SortedList"] = sortedcontainers.sortedlist.SortedList
sortedcontainers.sortedset.__dict__["recursive_repr"] = sortedcontainers.sortedlist.recursive_repr
exec(_code_sortedcontainers_sortedset, sortedcontainers.sortedset.__dict__)

_code_sortedcontainers_sorteddict = """
\"""Sorted Dict
==============
...
class SortedValuesView(ValuesView, Sequence):
    ...
    __delitem__ = _view_delitem
"""
sortedcontainers.sorteddict.__dict__["SortedList"] = sortedcontainers.sortedlist.SortedList
sortedcontainers.sorteddict.__dict__["recursive_repr"] = sortedcontainers.sortedlist.recursive_repr
sortedcontainers.sorteddict.__dict__["SortedSet"] = sortedcontainers.sortedset.SortedSet
exec(_code_sortedcontainers_sorteddict, sortedcontainers.sorteddict.__dict__)

_code_sortedcontainers = """
...
"""
sortedcontainers.__dict__["SortedList"] = sortedcontainers.sortedlist.SortedList
sortedcontainers.__dict__["SortedKeyList"] = sortedcontainers.sortedlist.SortedKeyList
sortedcontainers.__dict__["SortedListWithKey"] = sortedcontainers.sortedlist.SortedListWithKey
sortedcontainers.__dict__["SortedSet"] = sortedcontainers.sortedset.SortedSet
sortedcontainers.__dict__["SortedDict"] = sortedcontainers.sorteddict.SortedDict
sortedcontainers.__dict__["SortedKeysView"] = sortedcontainers.sorteddict.SortedKeysView
sortedcontainers.__dict__["SortedItemsView"] = sortedcontainers.sorteddict.SortedItemsView
sortedcontainers.__dict__["SortedValuesView"] = sortedcontainers.sorteddict.SortedValuesView
exec(_code_sortedcontainers, sortedcontainers.__dict__)
...
def main(**kwargs) -> None:
    ...
    ab = list(zip(map(int, readline().split()), map(int, readline().split())))
    cd = list(zip(map(int, readline().split()), map(int, readline().split())))
    ab.sort(reverse=True)
    cd.sort()

    ds = SortedList()
    for ai, bi in ab:
        while cd and cd[-1][0] >= ai:
            ds.add(cd.pop()[1])
        idx = ds.bisect_left(bi)
        if idx == len(ds):
            print("No")
            break
        ds.discard(ds[idx])
