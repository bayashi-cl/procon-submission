...
#line 3 "byslib/geometry/base.hpp"
...
#line 3 "byslib/geometry/point.hpp"
...
#line 3 "abc178_e/main.cpp"

namespace bys {
void solve() {
    auto n = input<int>();
    auto xy = input<geo::Point<int>>(n);
    vector<geo::Point<int>> xy_rot;
    for (auto&& xyi : xy) xy_rot.push_back(xyi.manhattan_rotate());
    int xmin = INF;
    int xmax = -INF;
    int ymin = INF;
    int ymax = -INF;
