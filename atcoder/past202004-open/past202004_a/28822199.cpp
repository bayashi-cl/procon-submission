...
#line 4 "past202004_a/main.cpp"

namespace bys {
void Solver::solve() {
    vector<string> f = {"B9", "B8", "B7", "B6", "B5", "B4", "B3", "B2", "B1",
                        "1F", "2F", "3F", "4F", "5F", "6F", "7F", "8F", "9F"};
    auto [s, t] = scanner.read<string, 2>();
    auto itrs = std::find(f.begin(), f.end(), s);
    auto itrt = std::find(f.begin(), f.end(), t);
    print(abs(std::distance(itrs, itrt)));
}
}  // namespace bys
