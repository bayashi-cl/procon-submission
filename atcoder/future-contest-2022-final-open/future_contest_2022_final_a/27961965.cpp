...
#line 10 "future_contest_2022_final_a/main.cpp"
...
string golf_rflf(string s) {
    s = std::regex_replace(s, std::regex("RFRFRFRF"), "4(RF)");
    s = std::regex_replace(s, std::regex("FRFRFRFR"), "4(FR)");
    s = std::regex_replace(s, std::regex("RFRFRF"), "3(RF)");
    s = std::regex_replace(s, std::regex("FRFRFR"), "3(FR)");
    s = std::regex_replace(s, std::regex("LFLFLFLF"), "4(LF)");
    s = std::regex_replace(s, std::regex("FLFLFLFL"), "4(FL)");
    s = std::regex_replace(s, std::regex("LFLFLF"), "3(LF)");
    s = std::regex_replace(s, std::regex("FLFLFL"), "3(FL)");
    return s;
}
